...
export function LabelsSection() {
  return (
    <section className="w-full py-16 px-4 md:px-8 bg-secondary text-white">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center max-w-5xl mx-auto">
        <div className="col-span-1 flex justify-center">
          <Image
            ...
            width={300}
            height={300}
            className="rounded-2xl w-50 md:w-75 h-auto"
          />
        </div>

        <div className="col-span-1 md:col-span-2 max-w-4xl mx-auto text-center md:text-left">
          <h2 className="text-headline-md text-white mb-6 md:mb-8">
            Cependant,
          </h2>
          <p className="text-body-lg text-justify mb-6 md:mb-8">
