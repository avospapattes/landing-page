...
export default function TestimonialsSection() {
  ...
  // Reduced rotation intensity slightly to prevent extreme clipping on mobile
              ...
              >
                <Dialog>
                  <DialogTrigger asChild>
                    <Card
                      className={`cursor-pointer h-fit relative bg-white border-3! border-primary! neo-shadow transition-all hover:scale-[1.02] active:scale-95 ${rotations[i % rotations.length]}`}
                    >
