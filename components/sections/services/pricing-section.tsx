    ...
    <section className="w-full py-16 px-4 md:px-8 bg-foreground">
      <div className="container mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h2 className="text-4xl md:text-5xl font-bold">Les Tarifs</h2>
          ...
          <Card className="flex flex-col border-2 border-transparent hover:border-primary/20 transition-colors duration-300 shadow-lg">
            ...
            <CardContent className="flex-1 space-y-6">
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-white neo-shadow">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium">Visite 30 minutes</span>
                  </div>
                ...
                <div className="flex justify-between items-center p-4 bg-white neo-shadow">
                  <div className="flex items-center gap-3">
                    <Clock className="w-5 h-5 text-muted-foreground" />
                    <span className="font-medium">Visite 45 minutes</span>
                  </div>
                ...
                <div className="flex justify-between items-center p-4 bg-white neo-shadow">
                  <div className="flex items-center gap-3">
                    <Clock className="w-5 h-5 text-muted-foreground" />
                    <span className="font-medium">Visite 1 heure</span>
                  </div>
              ...
              <div className="bg-foreground p-4 neo-shadow space-y-3">
                <h4 className="font text-white flex items-center gap-2">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white neo-shadow flex flex-col gap-2">
                  <div className="flex justify-between items-baseline">
                    <span className="font-bold text-lg">RDV Toiletteur</span>
                    <span className="text-xl font-bold text-primary">15 €</span>
                  </div>
                ...
                <div className="p-4 bg-white neo-shadow flex flex-col gap-2">
                  <div className="flex justify-between items-baseline">
                    <span className="font-bold text-lg">RDV Vétérinaire</span>
        ...
        {/* Suppléments */}
        {/* Suppléments */}
        <Card className="max-w-5xl mx-auto flex flex-col border-2 border-transparent hover:border-primary/20 transition-colors duration-300 shadow-lg">
          <CardHeader>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                <Plus className="w-6 h-6 text-primary" />
              </div>
              <CardTitle className="text-2xl font-bold">Suppléments</CardTitle>
            </div>
          </CardHeader>
        ...
        <div className="text-center pt-8 border-t max-w-2xl mx-auto">
